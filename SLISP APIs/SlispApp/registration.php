...
&& isset($_POST['Password']) && !empty(isset($_POST['Password']))){
    ...
    //Intializing the Local User data variables to be captured
  $username = $_POST['Username']; 
  $phone_number= $_POST['Phone_number']; 
  $password = $_POST['Password']; 
  $Role = "Local";
 
  $sql = "INSERT INTO users VALUES (NULL, '$username', '$phone_number', '$password','$Role')";  //Capture the new  Local User data into the users table.
